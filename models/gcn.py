...
class GCN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.gcn1 = base_GCN(2048, self.num_classes)
        self.gcn2 = base_GCN(1024, self.num_classes)
        self.gcn3 = base_GCN(512, self.num_classes)
        self.gcn4 = base_GCN(64, self.num_classes)
        self.gcn5 = base_GCN(64, self.num_classes)
